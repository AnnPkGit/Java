...
public class Starter {
    ...
    @Inject private IConfigReader configReader ;
    ...
    public void run() {
        ...
        ctrDemo.show() ;
        System.out.println(configReader.getParam("key"));
        System.out.println(configReader.getParam("prop"));
        System.out.println(configReader.getParam("noSuchParam"));
    }
